...
1. **اعطای دسترسی:**
   ...
   ```
>> object_name : نام جدول یا دیتابیس یا ...
   - مثال:
     ```sql
...
```shell
# in linux
apt info extension_name
sudo apt install extension_name
```
##### Step 2
...
>> https://pgpedia.info/c/contrib-module.html
##### **مراحل نصب:**
